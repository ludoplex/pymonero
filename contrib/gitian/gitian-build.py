...
def build():
    ...
    os.makedirs(f'monero-binaries/{args.version}', exist_ok=True)
    ...
    if args.linux:
        ...
        subprocess.check_call(
            [
                ...
                '--url',
                f'monero={args.url}',
                '../monero/contrib/gitian/gitian-linux.yml',
            ]
        )
        subprocess.check_call(
            [
        ...
        subprocess.check_call(
            f'mv build/out/monero-*.tar.gz ../monero-binaries/{args.version}',
            shell=True,
        )
    ...
    if args.windows:
        ...
        subprocess.check_call(
            [
                ...
                '--url',
                f'monero={args.url}',
                '../monero/contrib/gitian/gitian-win.yml',
            ]
        )
        subprocess.check_call(
            [
        ...
        subprocess.check_call(
            f'mv build/out/monero*.zip ../monero-binaries/{args.version}',
            shell=True,
        )
    ...
    if args.macos:
        ...
        subprocess.check_call(
            [
                ...
                '--url',
                f'monero{args.url}',
                '../monero/contrib/gitian/gitian-osx.yml',
            ]
        )
        subprocess.check_call(
            [
    ...
    if args.commit_files:
        ...
        subprocess.check_call(['git', 'add', f'{args.version}-win/{args.signer}'])
        subprocess.check_call(['git', 'add', f'{args.version}-osx/{args.signer}'])
        subprocess.check_call(
            [
                'git',
                'commit',
